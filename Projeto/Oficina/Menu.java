...
public class Menu{
    ...
    Scanner entradas= new Scanner(System.in);
      ...
      while(op3!= 0){
            ...
            Menu.clearBuffer(entradas);
            auxMecanico = new UsuarioMecanico(nomeMecanico,especialidadeDoMecanico);
            ...
            if(campo == 1){
                System.out.println("Insira o id do mecanico: ");
                int idMecanico = entradas.nextInt();
                Menu.clearBuffer(entradas);
                System.out.println("Insira o novo nome: ");
                nomeMecanico = entradas.nextLine();
                Menu.clearBuffer(entradas);
                auxMecanico.setNome(nomeMecanico);
                daoMecanico.editarMecanico(auxMecanico, "nome_do_mecanico", idMecanico);
            } else if(campo == 2){
                System.out.println("Insira o id do mecanico: ");
                int idMecanico = entradas.nextInt();
                Menu.clearBuffer(entradas);
                ...
                daoMecanico.editarMecanico(auxMecanico, "especialidade", idMecanico);
            } else {
                System.out.println("Opçao invalida");
            }
            break;
            ...
            int idMecanico = entradas.nextInt();
            Menu.clearBuffer(entradas);
            daoMecanico.deletarMecanico(idMecanico);
            break;
            case 0:
          ...
          while(op3 != 0){
            ...
            Menu.clearBuffer(entradas);
            auxCliente = new UsuarioCliente(nomeCliente, endereco, telefone, veiculo);
            ...
            if(campo == 1){
                ...
                daoCliente.editarCliente(auxCliente,"nome_do_cliente", idCliente);
            } 
                ...
                daoCliente.editarCliente(auxCliente, "endereco", idCliente);
            } 
                ...
                daoCliente.editarCliente(auxCliente, "telefone", idCliente);
            } 
            //Caso seja a quantidade
            else if(campo == 4 ){
                System.out.println("Insira o id do cliente: ");
                ...
                daoCliente.editarCliente(auxCliente, "veiculo", idCliente);
                } else {
                System.out.println("Opçao invalida");
            }
                break;
          ...
          System.out.println("Insira o ID do cliente: ");
          int idCliente = entradas.nextInt();
          daoCliente.deletarCliente(idCliente);
          break;
          }
      ...
      switch(op2){
        ...
        auxServico = new Servico(nomeDoServico,descServico, auxMecanico, orcamento, nomeDoCliente);
